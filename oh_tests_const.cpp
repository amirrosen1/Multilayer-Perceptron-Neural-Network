...
//	// check ctor of Dense
//	const Dense d(w1, bias1, activation::relu);
//
...
//
//	Matrix const weights1[] = { weights[0], weights[1], weights[2], weights[3] };
//	Matrix const biases1[] = { biases[0], biases[1], biases[2], biases[3] };
//
